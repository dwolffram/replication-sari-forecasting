...
#     runs = api.runs(
#         f"dwolffram-karlsruhe-institute-of-technology/{project}",
#         filters={
#             "$and": [
#                 {"sweep_name": sweep} if (sweep is not None) else None,
#                 {"config.model": model},
#                 {"config.test_year": test_year} if (test_year is not None) else None,
#                 {"config.use_covariates": use_covariates}
#                 if (use_covariates is not None)
#                 else None,
#                 {"config.multiple_series": multiple_series}
#                 if (multiple_series is not None)
#                 else None,
#                 {"config.lags": lags} if (lags is not None) else None,
#                 {"config.sample_weight": sample_weight}
